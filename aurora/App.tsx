...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 font-sans antialiased selection:bg-teal-500/30 flex flex-col overflow-hidden">
      ...
      <nav className="border-b border-white/5 bg-slate-950/80 backdrop-blur-2xl sticky top-0 z-[100] h-20 px-10 flex items-center justify-between shadow-2xl shrink-0">
